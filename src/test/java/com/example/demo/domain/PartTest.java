...
class PartTest {
    ...
    void setMin(){
        ...
        assertEquals(min, partIn.getMinInv(), "Inventory incorrect");
        partOut.setMinInv(min);
        assertEquals(min, partOut.getMinInv(), "Inventory incorrect");
    }
    @Test
    void setMax(){
        int max = 20;
        partIn.setMaxInv(max);
        assertEquals(max, partIn.getMaxInv(), "Wrong inventory");
        partOut.setMaxInv(max);
        assertEquals(max, partOut.getMaxInv(), "Wrong inventory");
    }
}